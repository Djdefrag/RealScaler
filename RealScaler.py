...
AI_models_list = SRVGGNetCompact_models_list + RealESRGAN_models_list
...
def user_input_checks():
    ...
    if tiles_resolution > 0: 
        if   selected_AI_model in RealESRGAN_models_list:      vram_multiplier = RRDB_vram_multiplier
